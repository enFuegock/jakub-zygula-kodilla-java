...
class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask() {
        ...
        double averageDays = project.getTaskLists().stream()
                ...
                .mapToLong(t -> Duration.between(t.getCreated().atStartOfDay(), LocalDate.now().atStartOfDay()).toDays())
                .average()
                .orElse(0);

        // Then
        assertEquals(10.0, averageDays, 0.01); // Średnia liczba dni powinna wynosić około 12.5
    }
